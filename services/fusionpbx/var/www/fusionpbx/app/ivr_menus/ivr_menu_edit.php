...
//content
	...
	*/
	...
	//--- begin: show_advanced -----------------------
		...
		echo "</td>\n";
		echo "<td width=\"70%\" class='vtable' align='left'>\n";
		echo "<select name='ivr_menu_invalid_sound' class='formfld' style='width: 350px;' ".((if_group("superadmin") || if_level("admin")) ? "onchange='changeToInput(this);'" : null).">\n";
		//misc optgroup
			if (if_group("superadmin") || if_level("admin")) {
				echo "<optgroup label='Misc'>\n";
		...
		echo "</td>\n";
		echo "<td class='vtable' align='left'>\n";
		echo "<select name='ivr_menu_exit_sound' class='formfld' style='width: 350px;' ".((if_group("superadmin") || if_level("admin")) ? "onchange='changeToInput(this);'" : null).">\n";
